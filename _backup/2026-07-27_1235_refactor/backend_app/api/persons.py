...
logger = logging.getLogger("judicial.api.persons")
...
def list_persons(
    ...
    if is_key_target is not None:
        query = query.where(Person.is_key_target == is_key_target)
    if prison_place:
