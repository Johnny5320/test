...
def test_desensitize_short_id():
    from app.api.persons import desensitize_id_card
    assert desensitize_id_card("") == ""
    assert desensitize_id_card("123") == "123"
    assert desensitize_id_card("1234567890") == "1234567890"
